// CR: Nice code, but you should have better used the model.
// CR: e.g build a matrix of objects { isMine, isFlagged, minesAround, isShown etc... }
// CR: Then you could have used the model and not using classes names for DOM manipulation.
